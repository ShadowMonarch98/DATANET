...
public class Estado extends javax.swing.JFrame {
    ...
    public Estado() {
        initComponents();
        String[] titulos = {"CODIGO DE ESTADO","DESCRIPCION DE ESTADO"};
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        estadoBL oEstados= recuperarDatosGIU();
        
        String strSentenciaInsert = String.format("INSERT INTO ESTADO (Cod_Estado, Des_Estado) "
                + "VALUES('%s','%s')",oEstados.getCod_estado(),oEstados.getDes_estado());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        Conexion objconexion = new Conexion();
        estadoBL oEstados= recuperarDatosGIU();
        String strSentenciaInsert = String.format("DELETE FROM ESTADO WHERE Cod_Estado = '%s'",oEstados.getCod_estado());
        objconexion.ejecutarSentenciaSQL(strSentenciaInsert);
        this.mostrardatos();
        this.limpiar();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        String strSentenciaInsert = String.format("UPDATE ESTADO SET Des_Estado='%s' "
                + "WHERE Cod_Estado = '%s'",oEstados.getDes_estado(),oEstados.getCod_estado());
        objconexion.ejecutarSentenciaSQL(strSentenciaInsert);
        this.mostrardatos();
        this.limpiar();
    ...
    public void mostrardatos(){
        ...
        Conexion objconexion = new Conexion();
        try {
            ResultSet resultado = objconexion.consultarRegistros("SELECT * FROM ESTADO");
            while (resultado.next()) {
                System.out.println(resultado.getString("Cod_Estado"));
                System.out.println(resultado.getString("Des_Estado"));
                Object[] oDispositivo = {resultado.getString("Cod_Estado"),resultado.getString("Des_Estado")};
    ...
    public estadoBL recuperarDatosGIU() {
        estadoBL oEstado = new estadoBL();
        
        oEstado.setCod_estado(txtCod_Estado.getText());
        oEstado.setDes_estado(txtDes_Estado.getText());
